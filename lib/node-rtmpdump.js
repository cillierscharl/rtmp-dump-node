...
RTMPDump.RTMPDumpCommand.prototype = {
	...
	launch : function(){
		...
		child.stdout.on('data',function(data){
			RTMPDump.util.externalInfo(data);
		});

		child.stderr.on('data',function(data){
			RTMPDump.util.externalError(data);
		});
	}
...
RTMPDump.util = {
	...
	externalInfo : function(text){
		console.log('[external - out] '.orange + text);
	},
	externalError : function(text){
		console.log('[external - error] '.red + text);
	}
}
